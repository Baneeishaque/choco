...
<!-- Intro-->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-xl-4 text-left">
                        <div class="text-big text-decorative text-primary wow fadeInLeft">Monte Alban</div>
                        <h3 class="wow fadeInLeft font-weight-bold text-decor-line text-spacing-200" data-wow-delay=".2s">Chocolate for you</h3>
                        <h4 class="wow fadeInLeft text-spacing-100 text-transform-none text-gray-600 font-weight-normal text-gray-600" data-wow-delay=".3s"><span class="d-xl-block">Monte Alban offers the best</span><span class="d-xl-block">Chocolates for you.</span></h4><a class="button button-lg button-shadow-2 button-primary button-zakaria wow fadeInUp" href="grid-shop.html">Explore Now</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="section section-sm bg-default pt-xl-0">
            <div class="container">
                <article class="promo-classic offset-negative-1">
                    <div class="promo-classic-title">Company Messege</div>
                    <p class="big promo-classic-text">We focus on manufacturing the best quality chocolate. Most of the people are taking good care of their diet and health conscious. Monte Alban's chocolates are irreplace able for those enthusiast from their diet. Monte Alban chocolate
                        company gives more importance on manufacturing chocolate products into its purest form</p>
                </article>
            </div>
        </section>
        <!-- About Us-->
            ...
            <div class="container">
                ...
                <div class="owl-carousel owl-style-8" data-items="1" data-sm-items="2" data-lg-items="3" data-margin="30" data-dots="true" data-mouse-drag="false">
                    <article class="box-info-modern wow slideInUp" data-wow-delay=".1s">
                        <a class="box-info-modern-figure" href="grid-shop.html"><img src="images/offer-1-340x243.jpg" alt="" width="340" height="243" /></a>
                        <h4 class="box-info-modern-title"><a href="grid-shop.html">Choco Balls</a></h4>
                        <div class="box-info-modern-text">Monte Alban chocolate balls are carefully formulated to make our customer enjoy the experience, continues to bring sweetness and remove the bittemess from families across the world.</div>
                    </article>
                    <article class="box-info-modern wow slideInUp">
                        <a class="box-info-modern-figure" href="grid-shop.html"><img src="images/offer-2-340x243.jpg" alt="" width="340" height="243" /></a>
                        <h4 class="box-info-modern-title"><a href="grid-shop.html">CHOCO SPREAD</a></h4>
                        <div class="box-info-modern-text"> We offer chocolate cream made by our unique way of preparation by which customer can enjoy every bit of it with pleasure and joy. These items are well enjoyed by kids.</div>
                    </article>
                    <article class="box-info-modern wow slideInUp" data-wow-delay=".1s">
                        <a class="box-info-modern-figure" href="grid-shop.html"><img src="images/offer-3-340x243.jpg" alt="" width="340" height="243" /></a>
                        <h4 class="box-info-modern-title"><a href="grid-shop.html">CHOCO & MILK</a></h4>
                        <div class="box-info-modern-text">Shakes and smoothies are always favorites for children. When it comes to chocolate milk shake it is enjoyed by everybody irrespective of any differentiation of age group.</div>
                    </article>
                </div>
            </div>
        </section>
                ...
                <div class="owl-carousel owl-style-10" data-items="1" data-sm-items="2" data-lg-items="3" data-margin="30" data-dots="true" data-mouse-drag="false">
                    ...
                    <article class="product">
                        <div class="product-body">
                            ...
                            <h5 class="product-title"><a href="grid-shop.html">COCHO BALLS</a></h5>
                    ...
                    <article class="product">
                        <div class="product-body">
                            ...
                            <h5 class="product-title"><a href="grid-shop.html">Chocolate SPREAD</a></h5>
                            <div class="product-price-wrap">
                            </div>
                        </div><span class="product-badge product-badge-new">New</span>
                        <div class="product-button-wrap">
                    ...
                    <article class="product">
                        <div class="product-body">
                            ...
                            <h5 class="product-title"><a href="grid-shop.html">Cocho&milk</a></h5>
                            <div class="product-price-wrap">
                            </div>
                        </div><span class="product-badge product-badge-new">New</span>
                        <div class="product-button-wrap">
                        ...
                        <div class="row row-30 row-md-40 row-lg-50 bordered-2">
                            <div class="col-sm-6 col-md-12">
                              ...
                              <path d="M1220.63,3358.07c8.86-19.66,32.66-7.87,38.1,13a39.053,39.053,0,0,1-27.91,47.63c-20.85,5.44-43.52-6.76-47.59-27.93C1179.83,3373.1,1210.55,3380.43,1220.63,3358.07Z" transform="translate(-1182.94 -3348.03)"></path>
                                        ...
                                        <div class="unit-body">
                                            <h4 class="box-icon-nancy-title"><a>Quality Products</a></h4>
                                        </div>
                                    </div>
                                </article>
                            </div>
                            <div class="col-sm-6 col-md-12">
                              ...
                              <path d="M1220.63,3358.07c8.86-19.66,32.66-7.87,38.1,13a39.053,39.053,0,0,1-27.91,47.63c-20.85,5.44-43.52-6.76-47.59-27.93C1179.83,3373.1,1210.55,3380.43,1220.63,3358.07Z" transform="translate(-1182.94 -3348.03)"></path>
                                        ...
                                        <div class="unit-body">
                                            <h4 class="box-icon-nancy-title"><a>Quality Packing</a></h4>
                        ...
                        <div class="row row-30 row-md-40 row-lg-50 bordered-2">
                            <div class="col-sm-6 col-md-12">
                              ...
                              <path d="M1220.63,3358.07c8.86-19.66,32.66-7.87,38.1,13a39.053,39.053,0,0,1-27.91,47.63c-20.85,5.44-43.52-6.76-47.59-27.93C1179.83,3373.1,1210.55,3380.43,1220.63,3358.07Z" transform="translate(-1182.94 -3348.03)"></path>
                                        ...
                                        <div class="unit-body">
                                            <h4 class="box-icon-nancy-title"><a>Rich in Chocolates</a></h4>
                            ...
                            <div class="col-sm-6 col-md-12">
                              ...
                              <path d="M1220.63,3358.07c8.86-19.66,32.66-7.87,38.1,13a39.053,39.053,0,0,1-27.91,47.63c-20.85,5.44-43.52-6.76-47.59-27.93C1179.83,3373.1,1210.55,3380.43,1220.63,3358.07Z" transform="translate(-1182.94 -3348.03)"></path>
                                        ...
                                        <div class="unit-body">
                                            <h4 class="box-icon-nancy-title"><a href="index.html#">More happiness</a></h4>
            ...
            <div class="container">
                ...
                <div class="row row-30 row-lg justify-content-center">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="tabs-1-1">
                                    <div class="box-info-creative">
                                        <h4 class="box-info-creative-title"><a>Monte Alben provides Best Chocolates In market</a></h4>
                                        <div class="box-info-creative-text">The Monte Alban chocolate manufacturer is here to full fill the need of the pure chocolate in the market for those health concious and diet maintaining people, Monte Alban's chocolate is the best addition of treat
                                            or dessert in to a diet. Monte Alban maintains the traditional qualities of all products which they manufacture, to ensure the pre mium standards of the same. Monte Alban already have great number of treats
                                            and
                                        </div>
                                    </div>
                                </div>
                  ...
                  <ul class="nav nav-tabs">
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="index.html#tabs-1-1" data-toggle="tab">Our mission</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="index.html#tabs-1-2" data-toggle="tab">Our Values</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="index.html#tabs-1-3" data-toggle="tab">Our goals</a></li>
                  </ul>
                </div> -->
                        </div>
                    </div>
        ...
        <div class="container">
          ...
          <div class="owl-carousel owl-style-10" data-items="1" data-sm-items="2" data-lg-items="3" data-margin="30" data-dots="true" data-mouse-drag="false">
            <article class="team-creative wow slideInUp" data-wow-delay=".1s">
              <div class="team-creative-header"><a class="team-creative-figure" href="index.html#"><img src="images/team-1-249x249.jpg" alt="" width="249" height="249"/></a>
                <div class="team-creative-decor"></div>
              </div>
              <div class="team-creative-body">
                <h4 class="team-creative-name"><a href="index.html#">richard smith</a></h4>
            ...
            <article class="team-creative wow slideInUp">
              <div class="team-creative-header"><a class="team-creative-figure" href="index.html#"><img src="images/team-2-249x249.jpg" alt="" width="249" height="249"/></a>
                <div class="team-creative-decor"></div>
              </div>
              <div class="team-creative-body">
                <h4 class="team-creative-name"><a href="index.html#">Susan Anderson</a></h4>
            ...
            <article class="team-creative wow slideInUp" data-wow-delay=".1s">
              <div class="team-creative-header"><a class="team-creative-figure" href="index.html#"><img src="images/team-3-249x249.jpg" alt="" width="249" height="249"/></a>
                <div class="team-creative-decor"></div>
              </div>
              <div class="team-creative-body">
                <h4 class="team-creative-name"><a href="index.html#">Steve Ruffalo</a></h4>
        ...
        <div class="container box-cta">
          ...
          <h2 class="text-spacing-75 text-black-800 wow fadeScale">All Kinds of Cakes</h2><a class="button button-lg button-primary button-zakaria wow fadeInUp" href="index.html#">Read More</a>
        </div>
      </section> -->
        ...
        <section class="section section-xxl bg-image-1">
            <div class="container">
                <h2 class="wow fadeScale">BLOGS</h2>
                        ...
                        <div class="row row-30">
                            <div class="col-6 col-md-12 wow fadeInRight">
                                ...
                                <article class="post post-nikki">
                                    <div class="unit unit-spacing-lg flex-column flex-md-row align-items-center">
                                        <div class="unit-left">
                                            <a class="post-nikki-figure" href="blog-post.html"><img src="images/post-2-270x215.jpg" alt="" width="270" height="215" /></a>
                                        </div>
                                        <div class="unit-body">
                                            <div class="post-nikki-time">
                                                <time datetime="2020-09-08">August 9, 2020</time>
                            ...
                            <div class="col-6 col-md-12 wow fadeInRight">
                                ...
                                <article class="post post-nikki">
                                    <div class="unit unit-spacing-lg flex-column flex-md-row align-items-center">
                                        <div class="unit-left">
                                            <a class="post-nikki-figure" href="blog-post.html"><img src="images/post-3-270x215.jpg" alt="" width="270" height="215" /></a>
                                        </div>
                                        <div class="unit-body">
                                            <div class="post-nikki-time">
                                                <time datetime="2020-09-08">August 9, 2020</time>

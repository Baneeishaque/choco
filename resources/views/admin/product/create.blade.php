        ...
        <div class="col-lg-12 col-sm-12">
            <div class="card" style="height:auto;">
                ...
                <div class="card-body">
                    ...
                    <form method='POST' enctype="multipart/form-data" action="{{ url('createProduct') }}">
                        <!--acton insertpdt "routes(web.php)" to the controller-->
                        <input type="hidden" name="id" value="id"> @csrf
                        <!-- Product name -->
                        <div class="form-group row">
                            <label for="product_name" class="col-md-4 col-form-label text-md-right">{{ __('Product
                                name') }}</label>
                            <div class="col-md-3">
                                <input name='name' id="product_name" type="text" class="form-control  required  autofocus">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input name='old_amount' id="old_amount" type="text" class="form-control autofocus">
                            </div>
                        </div>
                        <!-- Recent price -->
                        <div class="form-group row">
                            <label for="recent_amount" class="col-md-4 col-form-label text-md-right">{{ __('Recent
                                Amount') }}</label>
                            <div class="col-md-3">
                                <input name='recent_amount' type="text" class="form-control  required  autofocus">
                            </div>
                        </div>
                        <!-- Categories -->
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input name='weight' type="text" class="form-control    autofocus">
                            </div>
                        </div>
                        <!-- Box Size -->
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input name='box' type="text" class="form-control    autofocus">
                            </div>
                        </div>
                        <!-- description -->
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <textarea name="description" rows="4" cols="25" class="form-control  autofocus"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
